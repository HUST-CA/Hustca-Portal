...
$(document).ready(function(){
    ...
    $(".slide#first").backstretch("images/bgs.jpg");
    $(".slide#sec").backstretch("images/cwb.jpg");
    $(".slide#thirth").backstretch("images/qyb.jpg");
    $(".slide#fourth").backstretch("images/hdb.jpg");
    $(".slide#fifth").backstretch("images/mtb.jpg");
    $(".slide#sixth").backstretch("images/wlb.jpg");
