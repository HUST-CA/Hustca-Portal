...
<!-- saved from url=(0071)https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.1/modernizr.min.js -->
<HTML><HEAD><META content="IE=5.0000" http-equiv="X-UA-Compatible">

<META http-equiv="Content-Type" content="text/html; charset=gb2312">
<META name="GENERATOR" content="MSHTML 11.00.10240.16391"></HEAD>
<BODY>window.Modernizr=function(e,t,n){function r(e){b.cssText=e}function 
o(e,t){return r(S.join(e+";")+(t||""))}function a(e,t){return typeof 
e===t}function i(e,t){return!!~(""+e).indexOf(t)}function c(e,t){for(var r in 
e){var 
o=e[r];if(!i(o,"-")&amp;&amp;b[o]!==n)return"pfx"==t?o:!0}return!1}function 
...
d,f,m="2.8.1",p={},h=!0,g=t.documentElement,v="modernizr",y=t.createElement(v),b=y.style,E=t.createElement("input"),x=":)",w={}.toString,S=" 
...
a=["&shy;",'
<STYLE id="s',v,'">',e,"</STYLE>
"].join(""),u.id=v,(l?u:d).innerHTML+=a,d.appendChild(u),l||(d.style.background="",d.style.overflow="hidden",s=g.style.overflow,g.style.overflow="hidden",g.appendChild(d)),i=n(u,e),l?u.parentNode.removeChild(u):(d.parentNode.removeChild(d),g.style.overflow=s),!!i},z=function(t){var 
n=e.matchMedia||e.msMatchMedia;if(n)return n(t)&amp;&amp;n(t).matches||!1;var 
r;return F("@media "+t+" { #"+v+" { position: absolute; } 
...
e}(),L={}.hasOwnProperty;f=a(L,"undefined")||a(L.call,"undefined")?function(e,t){return 
t in e&amp;&amp;a(e.constructor.prototype[t],"undefined")}:function(e,t){return 
...
(",S.join("touch-enabled),("),v,")","{#modernizr{top:9px;position:absolute}}"].join(""),function(e){n=9===e.offsetTop}),n},M.geolocation=function(){return"geolocation"in 
...
e=t.createElement("div");return"draggable"in e||"ondragstart"in 
e&amp;&amp;"ondrop"in e},M.websockets=function(){return"WebSocket"in 
e||"MozWebSocket"in e},M.rgba=function(){return 
...
u("backgroundSize")},M.borderimage=function(){return 
u("borderImage")},M.borderradius=function(){return 
...
bottom,from(#9f9),to(white));",n="linear-gradient(left top,#9f9, white);";return 
r((e+"-webkit- ".split(" 
...
e=!!u("perspective");return e&amp;&amp;"webkitPerspective"in 
g.style&amp;&amp;F("@media 
(transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(t){e=9===t.offsetLeft&amp;&amp;3===t.offsetHeight}),e},M.csstransitions=function(){return 
...
Boolean(n),n.ogg=e.canPlayType('audio/ogg; 
...
e=t.createElement("div");return e.innerHTML="<svg xmlns="http://www.w3.org/2000/svg" 
/>",(e.firstChild&amp;&amp;e.firstChild.namespaceURI)==N.svg},M.smil=function(){return!!t.createElementNS&amp;&amp;/SVGAnimate/.test(w.call(t.createElementNS(N.svg,"animate")))},M.svgclippaths=function(){return!!t.createElementNS&amp;&amp;/SVGClipPath/.test(w.call(t.createElementNS(N.svg,"clipPath")))};for(var 
H in 
...
h&amp;&amp;h&amp;&amp;(g.className+=" "+(t?"":"no-")+e),p[e]=t}return 
p},r(""),y=E=null,function(e,t){function n(e,t){var 
n=e.createElement("p"),r=e.getElementsByTagName("head")[0]||e.documentElement;return 
n.innerHTML="x
<STYLE>"+t+"</STYLE>
",r.insertBefore(n.lastChild,r.firstChild)}function r(){var 
e=y.elements;return"string"==typeof e?e.split(" "):e}function o(e){var 
...
i(e,n){if(e||(e=t),l)return e.createDocumentFragment();n=n||o(e);for(var 
...
u,l,d="3.7.0",f=e.html5||{},m=/^&lt;|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,p=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,h="_html5shiv",g=0,v={};!function(){try{var 
...
t?u(e,t,n):u(e,"pfx")},g.className=g.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(h?" 
js "+$.join(" "):""),p}(this,this.document);</BODY></HTML>
