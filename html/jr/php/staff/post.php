...
$sql = "insert ignore into staff (name,sex,tel,email,major,apartment,building,room,reason,experience,groups) VALUES('$name','$sex','$tel','$email','$major','$apartment','$building','$room','$reason','$experience','$groups')";
//输进数据库
