...
dsy.add("0_0",["C 语言程序设计","C++ 语言程序设计","Visual Basic语言程序设计","Java语言程序设计","Access数据库程序设计","Visual Foxpro数据库程序设计","MySQL数据库程序设计","MS Office高级应用","Web程序设计"]);

dsy.add("0_1",["网络技术"," 数据库技术","软件测试技术 ","信息安全技术 ","嵌入式系统开发技术 "]);

dsy.add("0_2",["网络工程师"," 数据库工程师","软件测试工程师 ","信息安全工程师 ","嵌入式系统开发工程师 "]);
dsy.add("0",["二级","三级","四级"]);